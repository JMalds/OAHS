                    ...
                    <div class="form-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="password" name="password" class="form-control" placeholder="Enter your Password *" value="<?php echo $email; ?>"/>
                                </div>
                            </div>
              
                        </div>
                        <button type="submit" class="btnSubmit" name="login_btn">Login</button>
                        <br>
                        <br>
                        <p>
